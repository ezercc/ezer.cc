...
To receive delivery, you should:
...
- confirm that payment is not pending, failed, returned, or disputed.

## 6. Data and report availability

Company, period, source, and report-format coverage changes with public disclosures, licensing, and technical support. A subscription purchases software access; it does not guarantee coverage of every security, market, year, or filing, or that research is suitable for a particular decision.
